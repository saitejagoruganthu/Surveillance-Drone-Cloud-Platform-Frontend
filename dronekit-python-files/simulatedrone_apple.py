...
def send_telemetry(data):
    url = 'http://172.27.80.1:5001/api/telemetry/M006'
...
def send_notification(data):
    url = 'http://172.27.80.1:5001/api/notification/M006'
    headers = {'Content-Type': 'application/json'}
    response = requests.post(url, data=json.dumps(data, default=json_util.default), headers=headers, verify=False)
    if response.status_code == 200:
...
point1 = LocationGlobalRelative(37.331003, -122.029355, 20)
...
point2 = LocationGlobalRelative(37.331758, -122.028419, 20)
...
point3 = LocationGlobalRelative(37.332466, -122.029155, 20)
...
point4 = LocationGlobalRelative(37.331722, -122.030055, 20)
